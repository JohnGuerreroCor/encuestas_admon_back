...
public class TokenRestController {
	...
	public ResponseEntity<?> getToken(@PathVariable("username") String usuarioDb, HttpServletRequest request) {
		Map<String, Object> response = new HashMap<>();

		// OBTENER INFORMACIÓN DEL USUARIO
		Usuario usuario = usuarioservice.buscarUsuario(usuarioDb);
	...
	public ResponseEntity<?> validarToken(@PathVariable("username") String usuarioDb,
	...
	private String generartoken(Usuario usuarioLogueado, String ip) {
		String aplicativo = "77"; //IMPORTANTE REEMPLAZAR ESTE CÓDIGO CON EL MÓDULO CORRESPONDIENTE, BUSCAR EN LA TABLA MODULO DE LA BASE DE DATOS
