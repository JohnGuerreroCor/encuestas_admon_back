...
public class CuestionarioDaoImpl implements ICuestionarioDao {
	...
	public List<Cuestionario> buscar(int uaa) {
		...
		String sql = "select cue_codigo, cue_estado, cue_nombre, cue_instrucciones, uaa_nombre, cue_fecha_fin, cue_fecha_inicio, c.uaa_codigo "
				...
				+ "join dbo.uaa u on c.uaa_codigo = u.uaa_codigo "
				+ "where c.cue_estado = 1 and c.uaa_codigo = :uaa "
				+ "order by c.cue_codigo desc ";
	...
	@Override
	public void crearCompleto(Cuestionario cuestionario, String userdb) {
	...
	@Override
	public void crearFinalizacion(Cuestionario cuestionario, String userdb) {
	...
	@Override
	public void crearVacio(Cuestionario cuestionario, String userdb) {
	...
	@Override
	public void crearInicio(Cuestionario cuestionario, String userdb) {
	...
	@Override
	public void actualizar(Cuestionario cuestionario, String userdb) {
		...
		String sql = "UPDATE encuestas.cuestionarios SET cue_nombre=:nombre, cue_instrucciones=:instrucciones, "
				+ "cue_fecha_inicio=:inicio, cue_fecha_fin=:fin WHERE cue_codigo=:codigo ";
	...
	@Override
	public void borrar(int codigo, String userdb) {
