...
public class CuestionarioConfiguracionDaoImpl implements ICuestionarioConfiguracionDao {
	...
	@Override
	public List<CuestionarioConfiguracion> buscarTodos() {
		
		MapSqlParameterSource parameter = new MapSqlParameterSource();

		String sql = "select cuc_codigo, cuc_estado, ca.uaa_codigo, ca.cue_codigo, us.tus_codigo, "
				+ "us.tus_nombre, fecha_registro, cue_nombre, uaa_nombre, v.vin_codigo, vin_nombre "
				+ "from encuestas.cuestionario_configuracion ca "
